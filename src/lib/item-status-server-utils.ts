import { db } from './db';
import { ItemWithStatus, getItemStatus } from './item-status-utils';

/**
 * Get items owned by user with their computed status (SERVER-SIDE ONLY)
 */
...
/**
 * Get borrowed items for a user (SERVER-SIDE ONLY)
 */
...
/**
 * Get summary counts for user's items (SERVER-SIDE ONLY)
 */
